from utils import *
from init import *
from CustomClasses import NeuralNetwork, CNN, ImageDataset
...
MODEL = CNN(in_channels=3, out_channels=6, kernel_size=5, out_features=len(CLASSES)).to(
    DEVICE
)
...
def train(dataloader, model:net, loss_fn, optimizer):
